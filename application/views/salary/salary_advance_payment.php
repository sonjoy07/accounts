...
<!--                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="id_salary_advance" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Paid Amount Salary Advance Payment</label>
                            <div class="col-md-9">
                                <input type="text" name="paid_amount_salary_advance_payment" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Payment Date Salary Advance Payment</label>
                            <div class="col-md-9">
                                <input class="form-control datepicker" name="payemnt_date_salary_advance_payment" value="04/1/2016" type="text">
                            </div>
                        </div>
                        <div class="form-group">
