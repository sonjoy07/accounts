...
<!--                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <input type="text" id="payment" name="id_salary_payment" class="form-control" placeholder="payment" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Salary Bonus Type</label>
                            <div class="col-md-9">
                                <input type="text" id="bonus_type" name="id_salary_bonus_type" class="form-control" placeholder="Bonus Type" />
                            </div>
                        </div>
                        <div class="form-group">
